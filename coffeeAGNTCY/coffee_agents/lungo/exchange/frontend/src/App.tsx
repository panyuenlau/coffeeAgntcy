...
const App: React.FC = () => {
    ...
    const [selectedPattern, setSelectedPattern] = useState<PatternType>(PATTERNS.SLIM_MULTI_A2A);
    ...
    return (
        <div className="flex flex-col w-screen h-screen overflow-hidden bg-primary-bg">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div 
                    className="flex-1 flex flex-col bg-primary-bg border-l border-[#00142B]"
                >
